...
public class ticTacToeBoard extends View {
    ...
    public void drawHorizantalLine(Canvas canvas, int row, int col){
    ...
    private void drawWinningLine(Canvas canvas){
        ...
        switch (game.getWinType()[2]){
            case 1:
                drawHorizantalLine(canvas,row,col);break;
            case 2:
                drawVerticalLine(canvas,row,col);break;
            case 3:
                drawDiagonalLineNeg(canvas);break;
            case 4:
                drawDiagonalLinePos(canvas);break;
